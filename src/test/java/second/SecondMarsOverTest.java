...
class SecondMarsOverTest {
  ...
  void should_return_west_x_1_y_1_when_turn_right_given_south_x_1_y_1() {
    SecondMarsOver marsOver = new SecondSouthMarsOver(1, 1).turnRight();
  ...
  void should_return_south_x_1_y_1_when_turn_right_given_east_x_1_y_1() {
    SecondMarsOver marsOver = new SecondEastMarsOver(1, 1).turnRight();
  ...
  void should_return_north_x_1_y_1_when_turn_right_given_west_x_1_y_1() {
    SecondMarsOver marsOver = new SecondWestMarsOver(1, 1).turnRight();
